...
;; FIXED Angle Conversion - The issue was in the degree to radian conversion!
...
(defn lab-to-cm-angle-fixed [theta-lab-deg m1 m2]
  "Convert lab angle (in degrees) to CM angle (in radians) - FIXED"
  (let [theta-lab-rad (* theta-lab-deg Math/PI 180.0)  ; Convert to radians CORRECTLY
    ...
    (println "=== Debug Conversion (FIXED) ===")
...
(println "=== Testing 165° Lab Angle (FIXED) ===")
(def theta-cm-165 (lab-to-cm-angle-fixed 165.0 mp mAlpha))
...
(println "The issue was in my angle conversion, not the fundamental physics.")
