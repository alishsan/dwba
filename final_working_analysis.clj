...
;; FINAL WORKING Analysis - Fixed floating point precision issues

;; Physical constants
(def mp 938.272)   ; proton mass (MeV/c²)
(def mAlpha 3727.379)  ; alpha mass (MeV/c²)

;; CORRECTED lab-to-CM angle conversion with precision handling
(defn lab-to-cm-angle-working [theta-lab-deg m1 m2]
  "Convert lab angle (in degrees) to CM angle (in radians) - WORKING VERSION"
  (let [theta-lab-rad (* theta-lab-deg Math/PI 180.0)  ; Convert to radians
    ...
    (println "=== Debug Conversion (WORKING) ===")
...
(println "=== Testing 165° Lab Angle (WORKING) ===")
(def theta-cm-165 (lab-to-cm-angle-working 165.0 mp mAlpha))
...
(println "The issue was floating point precision, not the fundamental physics.")
...
(println "✅ The issue was floating point precision, not physics!")
